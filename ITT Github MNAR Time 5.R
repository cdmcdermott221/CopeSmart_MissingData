...
for (i in 1:1000) {
  ...
  #since 60% compliant
  Outcome_5_ITT60= ifelse(is.na(dtTrial$Outcome_5_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.60 + dtTrial$Tr4*0.60 + dtTrial$Tr2*0.60 + dtTrial$Tr3*0.60), dtTrial$Outcome_5)
  ...
  #since 40% compliant
  Outcome_5_ITT40= ifelse(is.na(dtTrial$Outcome_5_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.40 + dtTrial$Tr2*0.40 + dtTrial$Tr3*0.40 + dtTrial$Tr4*0.40), dtTrial$Outcome_5)
  ...
  #since 20% compliant
  Outcome_5_ITT20= ifelse(is.na(dtTrial$Outcome_5_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.20 + dtTrial$Tr4*0.20 + dtTrial$Tr2*0.20 + dtTrial$Tr3*0.20), dtTrial$Outcome_5)
