...
for (i in 1:1000) {
  ...
  dtTrial = dtTrial[, c("id", "trtGrp", "Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4", "Outcome_5", "Gender", "Age", "ITT_4", "ITT_5")]
  ...
  dtTrial = dtTrial[order(dtTrial$Outcome_4, decreasing=F), ]
  ...
  Del = rep(1, length(dtTrial$Outcome_4[dtTrial$trtGrp==0]))
  
  #create object length of intervention group, blank for now
  Del1 = rep(NA, length(dtTrial$Outcome_4[dtTrial$trtGrp==1]))
  ...
  test1= genData(length(x$Outcome_4), test2)
  test1 = test1[, "w"]
  ...
  #if someone is noncompliant at Time43, will be noncompliant for remainder of trial
  ...
  dtTrial2 = dtTrial3[, c("id", "trtGrp", "Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_05MNAR", "Outcome_5_05MNAR", "Gender", "Age")]
  ...
  dtTrial_long2 <- melt(dtTrial2,
                          ...
                          id.vars=c("id", "trtGrp", "Gender", "Age"),
                          # The source columns
                          measure.vars=c("Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_05MNAR", "Outcome_5_05MNAR" ),
                          # Name of the destination column that will identify the original
                          # column that the measurement came from
                          variable.name="Time",
                          value.name="Outcome")
  ...
  dtTrial_long2$Time = recode(dtTrial_long2$Time, " 'Outcome_3'=3")
  ...
  rm(Data1)
  Data1 = cbind(dtTrial, Outcome_4_ITT, Outcome_5_ITT)
  
  #For the Per Protocol dataset--with the blanks for those who are noncompliant
  Data1_cca = Data1[, c("id", "trtGrp", "Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_05MNAR", "Outcome_5_05MNAR", "Gender", "Age")]
  
  #for the ITT80 dataset (80%compliant)
  Data1_ITT = Data1[, c("id", "trtGrp", "Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_ITT", "Outcome_5_ITT", "Gender", "Age")]
  ...
  rm(Data1)
  Data1 = cbind(dtTrial, Outcome_4_ITT60, Outcome_5_ITT60)
  Data1_ITT60 = Data1[, c("id", "trtGrp", "Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_ITT60", "Outcome_5_ITT60", "Gender", "Age")]
  ...
  rm(Data1)
  Data1 = cbind(dtTrial, Outcome_4_ITT40, Outcome_5_ITT40)
  Data1_ITT40 = Data1[, c("id", "trtGrp", "Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_ITT40", "Outcome_5_ITT40", "Gender", "Age")]
  ...
  rm(Data1)
  Data1 = cbind(dtTrial, Outcome_4_ITT20, Outcome_5_ITT20)
  Data1_ITT20 = Data1[, c("id", "trtGrp", "Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_ITT20", "Outcome_5_ITT20", "Gender", "Age")]
  ...
  Data1_long$Time = recode(Data1_long$Time, " 'Outcome_3'=3")
  ...
  Data1_long_ITT <- melt(Data1_ITT,
                         ...
                         id.vars=c("id", "trtGrp", "Gender", "Age"),
                         # The source columns
                         measure.vars=c("Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_ITT", "Outcome_5_ITT" ),
                         # Name of the destination column that will identify the original
                         # column that the measurement came from
                         variable.name="Time",
                         value.name="Outcome")
  ...
  Data1_long_ITT$Time = recode(Data1_long_ITT$Time, " 'Outcome_3'=3")
  ...
  Data1_long_ITT60 <- melt(Data1_ITT60,
                           ...
                           id.vars=c("id", "trtGrp", "Gender", "Age"),
                           # The source columns
                           measure.vars=c("Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_ITT60", "Outcome_5_ITT60" ),
                           # Name of the destination column that will identify the original
                           # column that the measurement came from
                           variable.name="Time",
                           value.name="Outcome")
  ...
  Data1_long_ITT60$Time = recode(Data1_long_ITT60$Time, " 'Outcome_3'=3")
  ...
  Data1_long_ITT40 <- melt(Data1_ITT40,
                           ...
                           id.vars=c("id", "trtGrp", "Gender", "Age"),
                           # The source columns
                           measure.vars=c("Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_ITT40", "Outcome_5_ITT40" ),
                           # Name of the destination column that will identify the original
                           # column that the measurement came from
                           variable.name="Time",
                           value.name="Outcome")
  ...
  Data1_long_ITT40$Time = recode(Data1_long_ITT40$Time, " 'Outcome_3'=3")
  ...
  Data1_long_ITT20 <- melt(Data1_ITT20,
                           ...
                           id.vars=c("id", "trtGrp", "Gender", "Age"),
                           # The source columns
                           measure.vars=c("Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_ITT20", "Outcome_5_ITT20" ),
                           # Name of the destination column that will identify the original
                           # column that the measurement came from
                           variable.name="Time",
                           value.name="Outcome")
  ...
  Data1_long_ITT20$Time = recode(Data1_long_ITT20$Time, " 'Outcome_3'=3")
  ...
  Data2_long$Time = recode(Data2_long$Time, " 'Outcome_3'=3")
  ...
  LOCF4 = ifelse(is.na(Data3$Outcome_4_05MNAR), Data3$Outcome_3, Data3$Outcome_4_05MNAR)
  LOCF5 = ifelse(is.na(Data3$Outcome_5_05MNAR), Data3$Outcome_3, Data3$Outcome_5_05MNAR)
  Data3=cbind(Data3, LOCF4, LOCF5)
  
  #just getting new variables
  Data3=Data3[,c("id", "trtGrp", "Outcome_1", "Outcome_2", "Outcome_3", "LOCF4", "LOCF5", "Gender", "Age")]
  ...
  Data3_long <- melt(Data3,
                     ...
                     id.vars=c("id", "trtGrp", "Gender", "Age"),
                     # The source columns
                     measure.vars=c("Outcome_1", "Outcome_2", "Outcome_3", "LOCF4", "LOCF5" ),
                     # Name of the destination column that will identify the original
                     # column that the measurement came from
                     variable.name="Time",
                     value.name="Outcome")
  ...
  Data3_long$Time = recode(Data3_long$Time, " 'Outcome_3'=3")
  ...
  Data4_long$Time = recode(Data4_long$Time, " 'Outcome_3'=3")
  ...
  SingleLevelModel1= mxModel(
    "One Level Model", type="RAM", manifestVars=c("Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_05MNAR", 
                                                  "Outcome_5_05MNAR", "trtGrp"),
    latentVars=c("I", "S"), 
    mxData(observed=Data1, type="raw"),
    #compound symmetry covariance structure
    mxPath(from=c("Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_05MNAR", "Outcome_5_05MNAR"), arrows=2, free=T, values=c(1,1,1,1,1),
           labels=c("variance1","variance1", "variance1", "variance1", "variance1")),
    mxPath(from="Outcome_1", to=c("Outcome_2", "Outcome_3", "Outcome_4_05MNAR", "Outcome_5_05MNAR"), arrows=2, free=T, values=c(.8, .8, .8, .8),
           labels=c("covar1", "covar1", "covar1", "covar1")),
    mxPath(from="Outcome_2", to=c("Outcome_3", "Outcome_4_05MNAR", "Outcome_5_05MNAR"), arrows=2, free=T, values=c(.8,.8,.8),
           labels=c("covar1", "covar1", "covar1")),
    mxPath(from="Outcome_3", to=c("Outcome_4_05MNAR", "Outcome_5_05MNAR"), arrows=2, free=T, values=c(.8,.8),
    ...
    mxPath(from="I", to=c("Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_05MNAR", "Outcome_5_05MNAR"), arrows=1, free=F, 
           values=c(1, 1, 1,1,1)),
    #and the slope loadings have to be 0,1,2,3,4 from earliest to latest repeated measure
    mxPath(from="S", to=c("Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_05MNAR", "Outcome_5_05MNAR"), arrows=1, free=F, 
           values=c(0,1,2,3,4)),
    #manifest means not estimated
    mxPath(from="one", to=c("Outcome_1", "Outcome_2", "Outcome_3", "Outcome_4_05MNAR", "Outcome_5_05MNAR"), arrows=1, free=F,
           values=c(0, 0, 0, 0, 0)),
  ...
  meth[c("id", "trtGrp", "Gender", "Age", "Outcome_1", "Outcome_2", "Outcome_3")] = ""
  ...
  meth[c("Outcome_5_05MNAR", "Outcome_4_05MNAR")] = "norm"
  ...
  impMNAR05_ITT$Time = recode(impMNAR05_ITT$Time, " 'Outcome_3'=3")
...
WriteXLS(Total, ExcelFileName = "ITT_MNAR1000_20_trt_TP4.xlsx", col.names = TRUE, row.names=TRUE)
