...
pred["ESA_1_20MAR", ] = c(0, 1, 0, 0, 1, 1, 1, 0)
pred["ESA_2_20MAR", ] = c(0, 1, 0, 1, 0, 1, 1, 0)
pred["ESA_3_20MAR", ] = c(0, 1, 0, 1, 1, 0, 1, 0)
pred
...
pred["ESA_1_20MAR", ] = c(-2, 1, 0, 0, 1, 1, 1, 2)
pred["ESA_2_20MAR", ] = c(-2, 1, 0, 1, 0, 1, 1, 2)
pred["ESA_3_20MAR", ] = c(-2, 1, 0, 1, 1, 0, 1, 2)
pred

#method to impute these variables is the multilevel MI for continuous variables
meth[c("ESA_1_20MAR", "ESA_2_20MAR", "ESA_3_20MAR")] = "2l.norm"
