...
for (i in 1:1000) {
  ...
  #since 60% compliant
  Outcome_2_ITT60= ifelse(is.na(dtTrial$Outcome_2_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.60), dtTrial$Outcome_2)
  Outcome_3_ITT60= ifelse(is.na(dtTrial$Outcome_3_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.60 + dtTrial$Tr4*0.60), dtTrial$Outcome_3)
  Outcome_4_ITT60= ifelse(is.na(dtTrial$Outcome_4_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.60 + dtTrial$Tr4*0.60 + dtTrial$Tr2*0.60), dtTrial$Outcome_4)
  ...
  #since 40% compliant
  Outcome_2_ITT40= ifelse(is.na(dtTrial$Outcome_2_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.40), dtTrial$Outcome_2)
  Outcome_3_ITT40= ifelse(is.na(dtTrial$Outcome_3_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.40 + dtTrial$Tr2*0.40), dtTrial$Outcome_3)
  Outcome_4_ITT40= ifelse(is.na(dtTrial$Outcome_4_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.40 + dtTrial$Tr2*0.40 + dtTrial$Tr3*0.40), dtTrial$Outcome_4)
  ...
  #since 20% compliant
  Outcome_2_ITT20= ifelse(is.na(dtTrial$Outcome_2_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.20), dtTrial$Outcome_2)
  Outcome_3_ITT20= ifelse(is.na(dtTrial$Outcome_3_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.20 + dtTrial$Tr4*0.20), dtTrial$Outcome_3)
  Outcome_4_ITT20= ifelse(is.na(dtTrial$Outcome_4_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.20 + dtTrial$Tr4*0.20 + dtTrial$Tr2*0.20), dtTrial$Outcome_4)
