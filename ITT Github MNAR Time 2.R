...
for (i in 1:1000) {
  ...
  #since 80% compliant
  Outcome_2_ITT= ifelse(is.na(dtTrial$Outcome_2_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr*.80), dtTrial$Outcome_2)
  ...
  Data1_cca = Data1[, c("id", "trtGrp", "Outcome_1", "Outcome_2_05MNAR", "Outcome_3_05MNAR", "Outcome_4_05MNAR", "Outcome_5_05MNAR", "Gender", "Age")]
  ...
  #since 60% compliant
  Outcome_2_ITT60= ifelse(is.na(dtTrial$Outcome_2_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.60), dtTrial$Outcome_2)
  ...
  #since 40% compliant
  Outcome_2_ITT40= ifelse(is.na(dtTrial$Outcome_2_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.40), dtTrial$Outcome_2)
  ...
  #since 20% compliant
  Outcome_2_ITT20= ifelse(is.na(dtTrial$Outcome_2_05MNAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.20), dtTrial$Outcome_2)
  ...
  Data2_long <- melt(Data2,
                     ...
                     id.vars=c("id", "trtGrp", "Gender", "Age"),
                     # The source columns
                     measure.vars=c("Outcome_1", "Outcome_3_05MNAR", "Outcome_3_05MNAR", "Outcome_4_05MNAR", "Outcome_5_05MNAR" ),
                     # Name of the destination column that will identify the original
                     # column that the measurement came from
                     variable.name="Time",
                     value.name="Outcome")
  ...
  Data2_long$Time = recode(Data2_long$Time, " 'Outcome_3_05MNAR'=2")
  ...
  LOCF2 = ifelse(is.na(Data3$Outcome_2_05MNAR), Data3$Outcome_1, Data3$Outcome_2_05MNAR)
  LOCF3 = ifelse(is.na(Data3$Outcome_3_05MNAR), Data3$Outcome_1, Data3$Outcome_3_05MNAR)
  LOCF4 = ifelse(is.na(Data3$Outcome_4_05MNAR), Data3$Outcome_1, Data3$Outcome_4_05MNAR)
  LOCF5 = ifelse(is.na(Data3$Outcome_5_05MNAR), Data3$Outcome_1, Data3$Outcome_5_05MNAR)
  ...
  Data4$Outcome_2_05MNAR[is.na(Data4$Outcome_2_05MNAR)] <- mean(Data4$Outcome_2_05MNAR[Data4$trtGrp==1], na.rm = TRUE)
  ...
  Data4_long$Time = recode(Data4_long$Time, " 'Outcome_2_05MNAR'=2")
  ...
  pred["Outcome_2_05MNAR", ] = c(0, 1, 1, 0, 1, 1, 1, 1, 1)
...
WriteXLS(Total, ExcelFileName = "ITT_MNAR1000_20_trt_TP2.xlsx", col.names = TRUE, row.names=TRUE)
