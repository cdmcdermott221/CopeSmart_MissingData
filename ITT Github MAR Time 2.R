...
for (i in 1:1000) {
  ...
  #noncompliant, at random dependent upon Gender. Overall probability here is 20%, but can also be 5%, 10%, or 40%.
  Del1 = c(sample(c(0,1), length(x$Outcome_2[x$Gender==0]), replace=T, prob=c(0.1, 0.9)),
           sample(c(0,1), length(x$Outcome_2[x$Gender==1]), replace=T, prob = c(0.3, 0.7)))
  ...
  #since 80% compliant
  Outcome_2_ITT= ifelse(is.na(dtTrial$Outcome_2_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*.80), dtTrial$Outcome_2)
  Outcome_3_ITT= ifelse(is.na(dtTrial$Outcome_3_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*.80 + dtTrial$Tr2*0.80), dtTrial$Outcome_3)
  Outcome_4_ITT= ifelse(is.na(dtTrial$Outcome_4_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*.80 + dtTrial$Tr2*0.80 + dtTrial$Tr3*0.80), dtTrial$Outcome_4)
  Outcome_5_ITT= ifelse(is.na(dtTrial$Outcome_5_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*.80 + dtTrial$Tr2*0.80 + dtTrial$Tr3*0.80 + dtTrial$Tr4*0.80), dtTrial$Outcome_5)
  ...
  #since 60% compliant
  Outcome_2_ITT60= ifelse(is.na(dtTrial$Outcome_2_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.60), dtTrial$Outcome_2)
  Outcome_3_ITT60= ifelse(is.na(dtTrial$Outcome_3_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.60 + dtTrial$Tr4*0.60), dtTrial$Outcome_3)
  Outcome_4_ITT60= ifelse(is.na(dtTrial$Outcome_4_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.60 + dtTrial$Tr4*0.60 + dtTrial$Tr2*0.60), dtTrial$Outcome_4)
  Outcome_5_ITT60= ifelse(is.na(dtTrial$Outcome_5_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.60 + dtTrial$Tr4*0.60 + dtTrial$Tr2*0.60 + dtTrial$Tr3*0.60), dtTrial$Outcome_5)
  ...
  #since 40% compliant
  Outcome_2_ITT40= ifelse(is.na(dtTrial$Outcome_2_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.40), dtTrial$Outcome_2)
  Outcome_3_ITT40= ifelse(is.na(dtTrial$Outcome_3_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.40 + dtTrial$Tr2*0.40), dtTrial$Outcome_3)
  Outcome_4_ITT40= ifelse(is.na(dtTrial$Outcome_4_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.40 + dtTrial$Tr2*0.40 + dtTrial$Tr3*0.40), dtTrial$Outcome_4)
  Outcome_5_ITT40= ifelse(is.na(dtTrial$Outcome_5_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.40 + dtTrial$Tr2*0.40 + dtTrial$Tr3*0.40 + dtTrial$Tr4*0.40), dtTrial$Outcome_5)
  ...
  #since 20% compliant
  Outcome_2_ITT20= ifelse(is.na(dtTrial$Outcome_2_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.20), dtTrial$Outcome_2)
  Outcome_3_ITT20= ifelse(is.na(dtTrial$Outcome_3_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.20 + dtTrial$Tr4*0.20), dtTrial$Outcome_3)
  Outcome_4_ITT20= ifelse(is.na(dtTrial$Outcome_4_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.20 + dtTrial$Tr4*0.20 + dtTrial$Tr2*0.20), dtTrial$Outcome_4)
  Outcome_5_ITT20= ifelse(is.na(dtTrial$Outcome_5_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr1*0.20 + dtTrial$Tr4*0.20 + dtTrial$Tr2*0.20 + dtTrial$Tr3*0.20), dtTrial$Outcome_5)
  ...
  Data2_long$Time = recode(Data2_long$Time, " 'Outcome_2_05MAR'=2")
