...
for (i in 1:1000) {
  ...
  #ordering by Gender
  dtTrial = dtTrial[order(dtTrial$Gender), ]
  ...
  #noncompliant at random, dependent upon Gender. Probability here is 20% on average
  Del1 = c(sample(c(0,1), length(x$Outcome_2[x$Gender==0]), replace=T, prob=c(0.10, 0.90)),
           sample(c(0,1), length(x$Outcome_2[x$Gender==1]), replace=T, prob=c(0.30, 0.70)))
  ...
  dtTrial$Outcome_2_05MAR = ifelse(dtTrial$Del2==0, NA, dtTrial$Outcome_2)
  dtTrial$Outcome_3_05MAR = ifelse(dtTrial$Del2==0, NA, dtTrial$Outcome_3)
  dtTrial$Outcome_4_05MAR = ifelse(dtTrial$Del2==0, NA, dtTrial$Outcome_4)
  dtTrial$Outcome_5_05MAR = ifelse(dtTrial$Del2==0, NA, dtTrial$Outcome_5)
  ...
  dtTrial3$Outcome_2_05MAR = ifelse(is.na(dtTrial3$Outcome_2_05MAR), dtTrial3$ITT_2, dtTrial3$Outcome_2_05MAR)
  dtTrial3$Outcome_3_05MAR = ifelse(is.na(dtTrial3$Outcome_3_05MAR), dtTrial3$ITT_3, dtTrial3$Outcome_3_05MAR)
  dtTrial3$Outcome_4_05MAR = ifelse(is.na(dtTrial3$Outcome_4_05MAR), dtTrial3$ITT_4, dtTrial3$Outcome_4_05MAR)
  dtTrial3$Outcome_5_05MAR = ifelse(is.na(dtTrial3$Outcome_5_05MAR), dtTrial3$ITT_5, dtTrial3$Outcome_5_05MAR)
  
  #just getting the variables of interest
  dtTrial2 = dtTrial3[, c("id", "trtGrp", "Outcome_1", "Outcome_2_05MAR", "Outcome_3_05MAR", "Outcome_4_05MAR", "Outcome_5_05MAR", "Gender", "Age")]
  ...
  dtTrial_long2 <- melt(dtTrial2,
                          ...
                          id.vars=c("id", "trtGrp", "Gender", "Age"),
                          # The source columns
                          measure.vars=c("Outcome_1", "Outcome_2_05MAR", "Outcome_3_05MAR", "Outcome_4_05MAR", "Outcome_5_05MAR" ),
                          # Name of the destination column that will identify the original
                          # column that the measurement came from
                          variable.name="Time",
                          value.name="Outcome")
  ...
  dtTrial_long2$Time = recode(dtTrial_long2$Time, " 'Outcome_2_05MAR'=2")
  dtTrial_long2$Time = recode(dtTrial_long2$Time, " 'Outcome_3_05MAR'=3")
  dtTrial_long2$Time = recode(dtTrial_long2$Time, " 'Outcome_4_05MAR'=4")
  dtTrial_long2$Time = recode(dtTrial_long2$Time, " 'Outcome_5_05MAR'=5")
  ...
  #since 80% compliant
  Outcome_2_ITT= ifelse(is.na(dtTrial$Outcome_2_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*.80), dtTrial$Outcome_2)
  Outcome_3_ITT= ifelse(is.na(dtTrial$Outcome_3_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*.80 + dtTrial$S*.80), dtTrial$Outcome_3)
  Outcome_4_ITT= ifelse(is.na(dtTrial$Outcome_4_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*.80 + dtTrial$S*0.80 + dtTrial$R*0.80), dtTrial$Outcome_4)
  Outcome_5_ITT= ifelse(is.na(dtTrial$Outcome_5_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*.80 + dtTrial$S*0.80 + dtTrial$R*0.80 + dtTrial$Q*0.80), dtTrial$Outcome_5)
  ...
  Data1_cca = Data1[, c("id", "trtGrp", "Outcome_1", "Outcome_2_05MAR", "Outcome_3_05MAR", "Outcome_4_05MAR", "Outcome_5_05MAR", "Gender", "Age")]
  ...
  #since 60% compliant
  Outcome_2_ITT60= ifelse(is.na(dtTrial$Outcome_2_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.60), dtTrial$Outcome_2)
  Outcome_3_ITT60= ifelse(is.na(dtTrial$Outcome_3_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.60 + dtTrial$S*0.60), dtTrial$Outcome_3)
  Outcome_4_ITT60= ifelse(is.na(dtTrial$Outcome_4_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.60 + dtTrial$S*0.60 + dtTrial$R*0.60), dtTrial$Outcome_4)
  Outcome_5_ITT60= ifelse(is.na(dtTrial$Outcome_5_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.60 + dtTrial$Q*0.60 + dtTrial$S*0.60 + dtTrial$R*0.60), dtTrial$Outcome_5)
  ...
  #since 40% compliant
  Outcome_2_ITT40= ifelse(is.na(dtTrial$Outcome_2_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.40), dtTrial$Outcome_2)
  Outcome_3_ITT40= ifelse(is.na(dtTrial$Outcome_3_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.40 + dtTrial$S*0.40), dtTrial$Outcome_3)
  Outcome_4_ITT40= ifelse(is.na(dtTrial$Outcome_4_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.40 + dtTrial$S*0.40 + dtTrial$R*0.40), dtTrial$Outcome_4)
  Outcome_5_ITT40= ifelse(is.na(dtTrial$Outcome_5_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.40 + dtTrial$S*0.40 + dtTrial$R*0.40 + dtTrial$Q*0.40), dtTrial$Outcome_5)
  ...
  #since 20% compliant
  Outcome_2_ITT20= ifelse(is.na(dtTrial$Outcome_2_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.20), dtTrial$Outcome_2)
  Outcome_3_ITT20= ifelse(is.na(dtTrial$Outcome_5_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.20 + dtTrial$S*0.20), dtTrial$Outcome_3)
  Outcome_4_ITT20= ifelse(is.na(dtTrial$Outcome_5_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.20 + dtTrial$S*0.20 + dtTrial$R*0.20), dtTrial$Outcome_4)
  Outcome_5_ITT20= ifelse(is.na(dtTrial$Outcome_5_05MAR), (dtTrial$Outcome_1 + dtTrial$Tr*0.20 + dtTrial$Q*0.20 + dtTrial$S*0.20 + dtTrial$R*0.20), dtTrial$Outcome_5)
  ...
  Data1_long$Time = recode(Data1_long$Time, " 'Outcome_2_05MAR'=2")
  Data1_long$Time = recode(Data1_long$Time, " 'Outcome_3_05MAR'=3")
  Data1_long$Time = recode(Data1_long$Time, " 'Outcome_4_05MAR'=4")
  Data1_long$Time = recode(Data1_long$Time, " 'Outcome_5_05MAR'=5")
  ...
  Data2_long <- melt(Data2,
                     ...
                     id.vars=c("id", "trtGrp", "Gender", "Age"),
                     # The source columns
                     measure.vars=c("Outcome_1", "Outcome_3_05MAR", "Outcome_3_05MAR", "Outcome_4_05MAR", "Outcome_5_05MAR" ),
                     # Name of the destination column that will identify the original
                     # column that the measurement came from
                     variable.name="Time",
                     value.name="Outcome")
  ...
  Data2_long$Time = recode(Data2_long$Time, " 'Outcome_3_05MAR'=2")
  Data2_long$Time = recode(Data2_long$Time, " 'Outcome_3_05MAR'=3")
  Data2_long$Time = recode(Data2_long$Time, " 'Outcome_4_05MAR'=4")
  Data2_long$Time = recode(Data2_long$Time, " 'Outcome_5_05MAR'=5")
  ...
  LOCF2 = ifelse(is.na(Data3$Outcome_2_05MAR), Data3$Outcome_1, Data3$Outcome_2_05MAR)
  LOCF3 = ifelse(is.na(Data3$Outcome_3_05MAR), Data3$Outcome_1, Data3$Outcome_3_05MAR)
  LOCF4 = ifelse(is.na(Data3$Outcome_4_05MAR), Data3$Outcome_1, Data3$Outcome_4_05MAR)
  LOCF5 = ifelse(is.na(Data3$Outcome_5_05MAR), Data3$Outcome_1, Data3$Outcome_5_05MAR)
  ...
  Data4$Outcome_2_05MAR[is.na(Data4$Outcome_2_05MAR)] <- mean(Data4$Outcome_2_05MAR[Data4$trtGrp==1], na.rm = TRUE)
  Data4$Outcome_3_05MAR[is.na(Data4$Outcome_3_05MAR)] <- mean(Data4$Outcome_3_05MAR[Data4$trtGrp==1], na.rm = TRUE)
  Data4$Outcome_4_05MAR[is.na(Data4$Outcome_4_05MAR)] <- mean(Data4$Outcome_4_05MAR[Data4$trtGrp==1], na.rm = TRUE)
  Data4$Outcome_5_05MAR[is.na(Data4$Outcome_5_05MAR)] <- mean(Data4$Outcome_5_05MAR[Data4$trtGrp==1], na.rm = TRUE)
  ...
  Data4_long$Time = recode(Data4_long$Time, " 'Outcome_2_05MAR'=2")
  Data4_long$Time = recode(Data4_long$Time, " 'Outcome_3_05MAR'=3")
  Data4_long$Time = recode(Data4_long$Time, " 'Outcome_4_05MAR'=4")
  Data4_long$Time = recode(Data4_long$Time, " 'Outcome_5_05MAR'=5")
  ...
  SingleLevelModel1= mxModel(
    "One Level Model", type="RAM", manifestVars=c("Outcome_1", "Outcome_2_05MAR", "Outcome_3_05MAR", "Outcome_4_05MAR", 
                                                  "Outcome_5_05MAR", "trtGrp"),
    latentVars=c("I", "S"), 
    mxData(observed=Data1, type="raw"),
    #compound symmetry covariance structure
    mxPath(from=c("Outcome_1", "Outcome_2_05MAR", "Outcome_3_05MAR", "Outcome_4_05MAR", "Outcome_5_05MAR"), arrows=2, free=T, values=c(1,1,1,1,1),
           labels=c("variance1","variance1", "variance1", "variance1", "variance1")),
    mxPath(from="Outcome_1", to=c("Outcome_2_05MAR", "Outcome_3_05MAR", "Outcome_4_05MAR", "Outcome_5_05MAR"), arrows=2, free=T, values=c(.8, .8, .8, .8),
           labels=c("covar1", "covar1", "covar1", "covar1")),
    mxPath(from="Outcome_2_05MAR", to=c("Outcome_3_05MAR", "Outcome_4_05MAR", "Outcome_5_05MAR"), arrows=2, free=T, values=c(.8,.8,.8),
           labels=c("covar1", "covar1", "covar1")),
    mxPath(from="Outcome_3_05MAR", to=c("Outcome_4_05MAR", "Outcome_5_05MAR"), arrows=2, free=T, values=c(.8,.8),
           labels=c("covar1", "covar1")),
    mxPath(from="Outcome_4_05MAR", to=c("Outcome_5_05MAR"), arrows=2, free=T, values=.8,
           labels="covar1"),
    ...
    mxPath(from="I", to=c("Outcome_1", "Outcome_2_05MAR", "Outcome_3_05MAR", "Outcome_4_05MAR", "Outcome_5_05MAR"), arrows=1, free=F, 
           values=c(1, 1, 1,1,1)),
    #and the slope loadings have to be 0,1,2,3,4 from earliest to latest repeated measure
    mxPath(from="S", to=c("Outcome_1", "Outcome_2_05MAR", "Outcome_3_05MAR", "Outcome_4_05MAR", "Outcome_5_05MAR"), arrows=1, free=F, 
           values=c(0,1,2,3,4)),
    #manifest means not estimated
    mxPath(from="one", to=c("Outcome_1", "Outcome_2_05MAR", "Outcome_3_05MAR", "Outcome_4_05MAR", "Outcome_5_05MAR"), arrows=1, free=F,
           values=c(0, 0, 0, 0, 0)),
  ...
  pred["Outcome_2_05MAR", ] = c(0, 1, 1, 0, 1, 1, 1, 1, 1)
  pred["Outcome_3_05MAR", ] = c(0, 1, 1, 1, 0, 1, 1, 1, 1)
  pred["Outcome_4_05MAR", ] = c(0, 1, 1, 1, 1, 0, 1, 1, 1)
  pred["Outcome_5_05MAR", ] = c(0, 1, 1, 1, 1, 1, 0, 1, 1)
  
  #method to impute is "norm", for normally-distributed continous variables
  meth[c("Outcome_5_05MAR", "Outcome_4_05MAR", "Outcome_3_05MAR", "Outcome_2_05MAR")] = "norm"
  ...
  com_MAR05 = complete(imps, "long")
  
  #Next, changing to further long format via "Time"
  impMAR05_ITT <- melt(com_MAR05,
                        # ID variables - all the variables to keep but not split apart on
  ...
  impMAR05_ITT$Time = recode(impMAR05_ITT$Time, " 'Outcome_1'=1")
  impMAR05_ITT$Time = recode(impMAR05_ITT$Time, " 'Outcome_2_05MAR'=2")
  impMAR05_ITT$Time = recode(impMAR05_ITT$Time, " 'Outcome_3_05MAR'=3")
  impMAR05_ITT$Time = recode(impMAR05_ITT$Time, " 'Outcome_4_05MAR'=4")
  impMAR05_ITT$Time = recode(impMAR05_ITT$Time, " 'Outcome_5_05MAR'=5")
  ...
  for (j in 1:40){
    impMAR05_ITT$Time=as.integer(impMAR05_ITT$Time)
    
    lmm_mi <- lme(Outcome ~ Time + trtGrp + trtGrp*Time, 
                 random = list(id = ~1), 
                 corr = corCompSymm(form= ~Time),
                 data=impMAR05_ITT, subset=c(impMAR05_ITT$.imp==j), na.action="na.omit",
                 method = "REML",
...
WriteXLS(Total, ExcelFileName = "ITT_MAR1000_20_trt_TP2.xlsx", col.names = TRUE, row.names=TRUE)
